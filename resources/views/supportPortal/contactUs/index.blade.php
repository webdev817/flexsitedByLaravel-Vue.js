                        ...
                        <div class="col-sm-12">
                            <div class="card ">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input type="text" name="subject" class="form-control" required placeholder="Please Enter Subject" >
                                    </div>
                                    <div class="form-group col-md-12 mt-2">
                                      <textarea name="message" placeholder="Please Type your Message" required class="form-control" rows="8" cols="80"></textarea>
                                    </div>
