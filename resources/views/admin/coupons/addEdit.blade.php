                  ...
                  <div class="row mb-4">
                          ...
                          <div class="form-group">
                              ...
                              @isset($coupon)
                                <select class="form-control" name="status" id="status">
                                  ...
                                  <option @if($coupon->status == 0) selected @endif value="0">InActive</option>
                                </select>
                              @else
                                <select class="form-control" name="status" id="status">
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">
                              ...
                              <input class="form-control" type="number" max="100" min="1" id="percentOff" name="percentOff"
                              @isset($coupon) readonly
                      ...
                      <div class="col-lg-3">
                        ...
                        <label class="ckbox" for="freeLogo">
                          <input type="checkbox" id="freeLogo" @if (isset($coupon) && $coupon->freeLogo == 1) checked @endif name="freeLogo"><span>Yes</span>
                        </label>
                      </div>
                      <div class="col-lg-3">
                        <label class="w-100 mb-4 section-title fontSize12px">Free Flayer Design</label>
                        <label class="ckbox" for="freeFlayer">
                          <input type="checkbox" id="freeFlayer"  @if (isset($coupon) && $coupon->freeFlayer == 1) checked @endif name="freeFlayer"><span>Yes</span>
                        </label>
                      </div>
                      ...
                      <div class="col-lg-3">
                        ...
                        <label class="ckbox" for="freeBusinessCard">
                          <input type="checkbox" id="freeBusinessCard"  @if (isset($coupon) && $coupon->freeBusinessCard == 1) checked @endif name="freeBusinessCard"><span>Yes</span>
                        </label>
                      </div>
                      <div class="col-lg-3">
                        <label class="w-100 mb-4 section-title fontSize12px">Free One Page Website</label>
                        <label class="ckbox" for="freeOnePageWebsite">
                          <input type="checkbox" id="freeOnePageWebsite"  @if (isset($coupon) && $coupon->freeOnePageWebsite == 1) checked @endif name="freeOnePageWebsite"><span>Yes</span>
                        </label>
                      </div>
