<div class="row justify-content-center">
    <div class="col-12 col-md-6 col-lg-6 col-xl-6 grayColor mt-3 p-0">
        <h4 class="d-inline favColor">Logo Design</h4>
    </div>
...
<div class="row justify-content-center">
  <div class="col-12 col-md-6 col-lg-6 col-xl-6 px-0">
      <div class="borderFav input-group mb-3 p-1">
        ...
        <input type="text"  onclick="$('#logoExamples').trigger('click')"   class="logoExamples border-0 form-control shadow-none cstmFormControl cstmFontForDomainInput"  placeholder="Load examples of logos or images you would like to be considered" >
