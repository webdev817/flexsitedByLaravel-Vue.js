  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         @include('welcomeWizered.chat.chat')
      </div>
...
var apiEndPoint = '{{ route('supportChatApi') }}?sessionId={{ $sessionId }}';
var apiEndPointMine = '{{ route('supportChatMine') }}?sessionId={{ $sessionId }}';

var supportChat = new Vue({
  el: '#supportChat',
  data () {
    return {
      chat: null,
  ...
  methods: {
      ...
      scrollToEnd: function() {
        var container = this.$el.querySelector("#supportChatBody");
  ...
  mounted: function(){
    ...
    setInterval(() => {
      ...
      axios.post(apiEndPointMine,{
        ...
        var supportChat = response.data.data.supportChat;
        var status = response.data.status;

        if (supportChat.length == 0) {
          return 0;
        }

        if (status == 0) {
          this.chat = supportChat;
        }else {
