<div class="container mt-5 pt-3">
    ...
    <div class="row">
        ...
        <div class="col-12 p-1 col-sm-6 col-md-6 col-lg-3 col-xl-3">
            ...
            <div class="w-100 planOfferBox hideonMobileAndSM"> &nbsp; </div>
            <div class="w-100 planOfferBox hideonMobileAndSM"> &nbsp; </div>
            <div class="w-100 planOfferBox active"> <a href="{{ route('selectedWebsitePackege',1) }}">GET STARTED</a> </div>
        </div>
        ...
        <div class="col-12 p-1 col-sm-6 col-md-6 col-lg-3 col-xl-3">
            ...
            <div class="w-100 planOfferBox hideonMobileAndSM"> &nbsp; </div>
            <div class="w-100 planOfferBox active"> <a href="{{ route('selectedWebsitePackege',2) }}">GET STARTED</a> </div>
        ...
        <div class="col-12 p-1 col-sm-6 col-md-6 col-lg-3 col-xl-3">
            ...
            <div class="w-100 planOfferBox hideonMobileAndSM"> &nbsp; </div>
            <div class="w-100 planOfferBox hideonMobileAndSM"> &nbsp; </div>
            <div class="w-100 planOfferBox active"> <a href="{{ route('selectedWebsitePackege', 3) }}">GET STARTED</a> </div>
        ...
        <div class="col-12 p-1 col-sm-6 col-md-6 col-lg-3 col-xl-3">
            ...
            <div class="w-100 planOfferBox active"> <a href="{{ route('selectedWebsitePackege',4) }}">GET STARTED</a> </div>
